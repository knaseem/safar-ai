    ...
    useEffect(() => {
        async function fetchActivities() {
            ...
            try {
                ...
                const res = await fetch(`/api/activities/search?query=${encodeURIComponent(cityName)}&category=attractions`);
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 className="text-xl font-bold">Top Rated Experiences in {cityName}</h3>
                    <p className="text-white/40 text-sm">Curated selection of high-demand activities</p>
                </div>
